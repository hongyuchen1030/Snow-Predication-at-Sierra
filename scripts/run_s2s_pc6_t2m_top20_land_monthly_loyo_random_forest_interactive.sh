...
OUTPUT_DIR="$REPO_ROOT/artifacts/s2s_pc6_t2m_top20_land_monthly_loyo_random_forest"
...
PYTHONPATH=src:. python -u scripts/run_s2s_pc6_t2m_top20_land_monthly_loyo_random_forest.py \
